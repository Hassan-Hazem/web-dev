...
import { createUser, findUserByGoogleId, findUserByEmail } from '../repositories/userRepository.js';
...
passport.use(new GoogleStrategy({
    ...
    try {
      ...
      const newUsername = profile.displayName.split(' ').join('') + Math.floor(Math.random() * 10000);
