  ...
  return (
    <div className="auth-form-container">
      ...
      <p className="auth-legal-text">
        ...
        <a href="#" className="auth-link">User Agreement</a> and acknowledge that you
        understand the{" "}
      ...
      <form onSubmit={handleSubmit} className="auth-form">
        ...
        <button
          type="submit"
            className={`auth-submit-btn ${(!isFormValid || loading) ? "disabled" : ""}`}
      ...
      <p className="auth-footer-text">
        New to Reddit?{" "}
        <button onClick={onSwitchToSignup} className="auth-switch-link" disabled={loading}>
          Sign Up
        </button>
      </p>
    </div>
